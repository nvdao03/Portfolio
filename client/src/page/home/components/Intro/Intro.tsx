import avatar from '../../../../assets/imgs/avatar/avatar-main.jpg';
import {
  BehanceIcon,
  DribbbleIocn,
  Instagram,
...
export default function Intro() {
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center custom-container">
      <div className="max-w-[540px] text-center">
        <a href="https://www.facebook.com/van.ao.547278/">
          <img
            src={avatar}
            alt="Văn Đạo"
            className="mb-[15px] rounded-[50%] w-[108px] h-[108px] bg-center mx-auto"
          />
        </a>
        <h1 className="text-[30px] font-bold mb-[5px]">Van Dao</h1>
        <span className="block mt-3">Im a Front-End developer</span>
        <div className="flex gap-x-[17px] my-[25px]">
          <a
            href="https://www.instagram.com/"
            className="text-[13px] text-title-color transition duration-[0.4s] hover:text-[#ffd15c]"
          >
            <Instagram />
          </a>
          <a
        ...
        <a href="#contact" className="custom-btn-primary">
          Hire Me
        </a>
        <div className="absolute bottom-[25px] left-0 w-full">
          <a href="#about">
            <span className="text-text-color">Scroll Down</span>
            <span className="block w-[13px] h-[16px] m-auto rounded-[10px] relative mt-[10px] border-[2px] border-solid border-[#454360]">
              <span className="bg-title-color w-[2px] h-[2px] absolute -translate-x-2/4 rounded-[100%] left-2/4 top-[5px] animate-aniMouse"></span>
            </span>
          </a>
        </div>
        ...
        <div className="absolute left-0 top-0 h-full w-full -z-[1]">
          ...
          <svg
            width="47"
            height="29"
            className="absolute right-[11%] top-[45%]"
            xmlns="http://www.w3.org/2000/svg"
          >
